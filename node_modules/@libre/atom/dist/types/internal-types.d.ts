 ...
 * ```
 */
export declare type AtomState<A extends Atom<any>> = A extends Atom<infer S> ? S : never;
/** @ignore */
export declare type Primitive = undefined | null | boolean | string | number | ((...args: Array<any>) => any);
/** @ignore */
 ...
 */
export declare type DeepImmutable<T> = T & (T extends Primitive ? T : T extends Array<infer U> ? DeepImmutableArray<U> : T extends Map<infer K, infer V> ? DeepImmutableMap<K, V> : DeepImmutableObject<T>);
/** @ignore */
