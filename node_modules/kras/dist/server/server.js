...
class MockServer extends core_1.MockServerCore {
    ...
    setup() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield management_1.withManagement(this, config);
            yield injectors_1.withInjectors(this, config);
            yield helpers_1.withMiddlewares(this, config);
            yield helpers_1.withFiles(this, config);
        });
    }
    stop() {
        const _super = Object.create(null, {
...
function readKrasConfig(options, ...files) {
    ...
    const configurations = files
        .filter(Boolean)
        .map((file) => path_1.resolve(dir, file))
        .filter(isUnique)
        .map((path) => config_1.readConfiguration(path));
    return config_1.mergeConfiguration(options, ...configurations);
}
exports.readKrasConfig = readKrasConfig;
function buildKras(config) {
    const options = config_1.buildConfiguration(config);
...
function runFromCli(options, rcfile) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = readKrasConfig(options, path_1.resolve(os_1.homedir(), info_1.krasrc), path_1.resolve(info_1.currentDir, info_1.krasrc), rcfile);
