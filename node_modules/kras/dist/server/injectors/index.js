...
function normalizeRequest(targets, req) {
    ...
    const query = Object.assign(Object.assign({}, req.addedQuery), req.query);
    const headers = Object.assign(Object.assign({}, req.addedHeaders), req.headers);
    let content;
...
function findInjectorIn(injectorDir, name) {
    ...
    for (const path of paths) {
        const target = path_1.resolve(path, name);
