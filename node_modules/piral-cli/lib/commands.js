    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .default('language', (0, helpers_1.keyOfSourceLanguage)(apps.newPiralDefaults.language))
                .string('template')
        ...
        run(args) {
            return apps.newPiral(args.base, {
                ...
                forceOverwrite: (0, helpers_1.valueOfForceOverwrite)(args['force-overwrite']),
                language: (0, helpers_1.valueOfSourceLanguage)(args.language),
    ...
    },
    {
        ...
        flags(argv) {
            return argv
                ...
                .default('language', (0, helpers_1.keyOfSourceLanguage)(apps.newPiletDefaults.language))
                .string('template')
                .describe('template', 'Sets the boilerplate template package to be used when scaffolding.')
