...
export declare const sourceLanguageKeys: string[];
export declare function valueOfSourceLanguage(key: string): SourceLanguage;
export declare function keyOfSourceLanguage(value: SourceLanguage): string;
