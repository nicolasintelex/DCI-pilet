...
function makePiletExternals(root, dependencies, externals, fromEmulator, piralInfo) {
    if (fromEmulator) {
        const { sharedDependencies = mergeExternals(externals, constants_1.legacyCoreExternals) } = piralInfo;
