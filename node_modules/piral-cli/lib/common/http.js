...
exports.postFile = exports.postForm = exports.downloadFile = void 0;
...
function postForm(target, scheme, key, formData, customHeaders = {}, ca, interactive = false) {
    ...
    const headers = Object.assign(Object.assign(Object.assign({}, form.getHeaders()), info_1.standardHeaders), customHeaders);
    if (key) {
        switch (scheme) {
            case 'basic':
        ...
        if (error.response) {
            ...
            if (interactive && 'interactiveAuth' in data) {
                ...
                if (typeof interactiveAuth === 'string') {
                    ...
                    return (0, interactive_1.getTokenInteractively)(interactiveAuth, httpsAgent).then(({ mode, token }) => postForm(target, mode, token, formData, customHeaders, ca, false));
                }
            }
...
function postFile(target, scheme, key, file, customFields = {}, customHeaders = {}, ca, interactive = false) {
    const data = Object.assign(Object.assign({}, customFields), { file: [file, 'pilet.tgz'] });
