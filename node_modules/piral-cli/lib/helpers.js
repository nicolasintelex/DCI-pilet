...
exports.keyOfSourceLanguage = exports.valueOfSourceLanguage = exports.sourceLanguageKeys = exports.keyOfForceOverwrite = exports.valueOfForceOverwrite = exports.forceOverwriteKeys = exports.frameworkKeys = exports.availableReleaseProviders = exports.availableBundlers = exports.bundlerKeys = exports.clientTypeKeys = exports.piletBuildTypeKeys = exports.piralBuildTypeKeys = exports.fromKeys = exports.publishModeKeys = exports.schemaKeys = void 0;
...
exports.sourceLanguageKeys = Object.keys(enums_1.SourceLanguage).filter((m) => typeof enums_1.SourceLanguage[m] === 'number');
function valueOfSourceLanguage(key) {
    for (const piletLanguageKey of exports.sourceLanguageKeys) {
...
exports.valueOfSourceLanguage = valueOfSourceLanguage;
function keyOfSourceLanguage(value) {
    for (const piletLanguageKey of exports.sourceLanguageKeys) {
        if (enums_1.SourceLanguage[piletLanguageKey] === value) {
            return piletLanguageKey;
        }
    }
    return exports.sourceLanguageKeys[0];
}
exports.keyOfSourceLanguage = keyOfSourceLanguage;
